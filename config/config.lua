...
-- Language: "da" (Danish) or "en" (English). Texts are in locales/locales.lua.
TOB.Locale = "da"
...
TOB.VaultCloseDelay = 10 -- seconds between the last trolley being looted and the vault closing
...
TOB.Notify = "auto" -- "auto", "ox_lib", "mythic_notify" or "native". "auto" uses ox_lib, then mythic_notify, then GTA notifications
